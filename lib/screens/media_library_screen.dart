  ...
  List<MediaItem> get _filteredMedia {
    ...
    switch (_selectedCategory) {
      case MediaCategory.all:
        items = List.from(MockMediaData.allMedia);
        break;
      case MediaCategory.videos:
        items = MockMediaData.videos;
        break;
      case MediaCategory.photos:
        items = MockMediaData.photos;
        break;
      case MediaCategory.music:
        items = MockMediaData.music;
        break;
      case MediaCategory.recent:
        items = MockMediaData.recentlyAdded(days: 3);
        break;
      case MediaCategory.favorites:
        items = MockMediaData.favorites;
        break;
    }
  ...
  Widget _buildEmptyState() {
    ...
    if (_searchQuery.isNotEmpty) {
      ...
      switch (_selectedCategory) {
        case MediaCategory.videos:
          title = 'No Videos';
          message = 'There are no videos in your library yet.';
          icon = CupertinoIcons.film;
          break;
        case MediaCategory.photos:
          title = 'No Photos';
          message = 'There are no photos in your library yet.';
          icon = CupertinoIcons.photo;
          break;
        case MediaCategory.music:
          title = 'No Music';
          message = 'There are no songs in your library yet.';
        ...
        case MediaCategory.all:
          ...
          message = 'Cast or add media to your library to see it here.';
